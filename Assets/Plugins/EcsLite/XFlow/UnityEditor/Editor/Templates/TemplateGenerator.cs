...
namespace Flow.EcsLite.UnityEditor.Templates {
    sealed class TemplateGenerator : ScriptableObject {
        const string Title = "FlowECS template generator";
        ...
        [MenuItem ("Assets/Create/FlowECS Lite/Create Startup from template", false, -200)]
        ...
        [MenuItem ("Assets/Create/FlowECS Lite/Systems/Create InitSystem from template", false, -199)]
        ...
        [MenuItem ("Assets/Create/FlowECS Lite/Systems/Create RunSystem from template", false, -198)]
        ...
        [MenuItem ("Assets/Create/FlowECS Lite/Components/Create Component from template", false, -197)]
