...
namespace XFlow.Modules.Box2D.ClientServer.Api
{
    public static partial class Box2DApi
    {
...
#else
        private const string DllName = "libbox2d-unity";
#endif
        ...
        [DllImport(DllName)]
        public static extern IntPtr CreateBody(IntPtr world, BodyType bodyType, Vector2 position, float angle, int entity, bool isFixedRotation);
        ...
        [Obsolete("use DestroyBody2")]
        [DllImport(DllName)]
        public static extern void DestroyBody(IntPtr world, IntPtr body);
        [DllImport(DllName)]
        public static extern void DestroyBody2(IntPtr body);
        ...
        [DllImport(DllName)]
        public static extern Vector2 GetForce(IntPtr body);
        ...
        [DllImport(DllName)]
        public static extern void SetBodyInfo2(IntPtr body, Vector2 pos, float angle, Vector2 linearVelocity, float angularVelocity);
        ...
        [DllImport(DllName)]
        public static extern IntPtr CloneWorld(IntPtr[] dataArr, int count, IntPtr world);
        ...
        [DllImport(DllName)]
        public static extern BodyType GetType(IntPtr body);

        [DllImport(DllName)]
        public static extern void SetType(IntPtr body, BodyType type);
...
// WHEEL JOINT
        ...
        [DllImport(DllName)]
        public static extern IntPtr CreateContactListener();
        
        //may returns default box2d version, you shouldnot destroy it
        [DllImport(DllName)]
        public static extern IntPtr GetContactListener(IntPtr WorldInstance);
        
        [DllImport(DllName)]
        public static extern void DestroyContactListener(IntPtr ListenerInstance);
            
        [DllImport(DllName)]
        public static extern void SetContactCallbacks2(IntPtr ListenerInstance, IntPtr UserPtr, 
                CollisionCallback beginContact,
                CollisionCallback endContact, 
                CollisionCallback preSolve, 
                CollisionCallback postSolve);
        
        [DllImport(DllName)]
        public static extern void SetContactListener(IntPtr WorldInstance, IntPtr ListenerInstance);
    }
}